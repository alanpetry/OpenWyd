...
struct STRUCT_MOBExtra
{
	...
	std::int32_t SecLearnedSkill; // 2 - 5
	...
	struct
	{
		...
		std::int32_t LearnedSkill; // The skills the mob learned, divided into four categories (00 _ 00 _ 00 _ 00)
		std::int32_t SecLearnedSkill; // 263 - 266
...
struct STRUCT_QUEST
{
	...
	short IdMob3;
	short QtdMob3;
	std::int32_t ExpReward; // Experiencia que sera dada ao concluir a quest
...
struct STRUCT_QUESTDIARIA
{
	...
	short QtdItem;
	std::int32_t ExpReward;
	std::int32_t GoldReward;
};
