...
def main() -> int:
    ...
    extra_exports = [
        ...
        "_free",
        "_wyd_render_client",
        "_wyd_renderer_set_backend",
        "_wyd_renderer_backend",
        "_wyd_native_renderer_enabled",
        "_wyd_native_renderer_last_command_count",
        "_wyd_native_renderer_last_supported_draws",
        "_wyd_native_renderer_last_fallback_draws",
        "_wyd_native_renderer_last_frame_id_low",
        "_wyd_native_renderer_last_stream_hash_low",
        ...
        "_wyd_native_renderer_command_vs_hash_high",
        "_wyd_native_renderer_command_ps_hash_low",
        "_wyd_native_renderer_command_ps_hash_high",
        "_wyd_native_renderer_command_blend",
        "_wyd_native_renderer_command_depth",
        "_wyd_native_renderer_command_raster",
        ...
        "_wyd_d3d9_set_optimized_sharpen_enabled",
        "_wyd_d3d9_optimized_sharpen_enabled",
        "_wyd_d3d9_optimized_sharpen_strength",
        "_wyd_d3d9_set_optimized_ui_sharpen_enabled",
        "_wyd_d3d9_optimized_ui_sharpen_enabled",
        "_wyd_d3d9_optimized_ui_sharpen_strength",
        "_wyd_d3d9_optimized_ui_sharpened_textures",
        "_wyd_d3d9_optimized_ui_sharpened_pixels",
        "_wyd_d3d9_set_optimized_ui_hd_enabled",
        "_wyd_d3d9_optimized_ui_hd_enabled",
        "_wyd_d3d9_optimized_ui_hd_scale",
        "_wyd_d3d9_optimized_ui_hd_textures",
        "_wyd_d3d9_optimized_ui_hd_source_pixels",
        "_wyd_d3d9_optimized_ui_hd_physical_pixels",
        "_wyd_d3d9_optimized_ui_hd_microseconds",
        "_wyd_d3d9_set_optimized_material_hd_enabled",
        "_wyd_d3d9_optimized_material_hd_enabled",
        "_wyd_d3d9_optimized_material_hd_scale",
        "_wyd_d3d9_optimized_material_hd_textures",
        "_wyd_d3d9_optimized_material_hd_source_pixels",
        "_wyd_d3d9_optimized_material_hd_physical_pixels",
        "_wyd_d3d9_optimized_material_hd_microseconds",
        "_wyd_d3d9_optimized_material_hd_repeat_x",
        "_wyd_d3d9_optimized_material_hd_repeat_y",
        "_wyd_d3d9_optimized_material_hd_model_textures",
        "_wyd_d3d9_optimized_material_hd_model_source_pixels",
        "_wyd_d3d9_optimized_material_hd_sample_count",
        "_wyd_d3d9_optimized_material_hd_sample",
        "_wyd_d3d9_set_optimized_offline_hd_enabled",
        "_wyd_d3d9_optimized_offline_hd_enabled",
        "_wyd_d3d9_optimized_offline_hd_loaded",
        "_wyd_d3d9_optimized_offline_hd_rejected",
        "_wyd_d3d9_optimized_offline_hd_source_pixels",
        "_wyd_d3d9_optimized_offline_hd_physical_pixels",
        "_wyd_d3d9_optimized_offline_hd_sample_count",
        "_wyd_d3d9_optimized_offline_hd_sample",
        "_wyd_d3d9_drawn_texture_path_count",
        "_wyd_d3d9_drawn_texture_path",
        ...
        "_wyd_control_visible_text_align",
        "_wyd_control_visible_text_comma",
        "_wyd_control_visible_text_x",
        "_wyd_control_visible_text_y",
        "_wyd_control_visible_text_width",
        "_wyd_control_visible_text_height",
        "_wyd_control_visible_text_render_x",
        "_wyd_control_visible_text_render_y",
        "_wyd_control_visible_text_extent_width",
        "_wyd_control_visible_text_extent_height",
        "_wyd_control_visible_text_color",
        "_wyd_control_visible_text_value",
        "_wyd_control_audit_count",
        "_wyd_control_audit_id",
        "_wyd_control_audit_parent_id",
        "_wyd_control_audit_type",
        "_wyd_control_audit_visible",
        "_wyd_control_audit_raw_visible",
        "_wyd_control_audit_depth",
        "_wyd_control_audit_set_raw_visible",
        "_wyd_control_audit_reveal_with_ancestors",
        "_wyd_control_audit_prepare_runtime_panel",
        "_wyd_control_audit_local_x",
        "_wyd_control_audit_local_y",
        "_wyd_control_audit_abs_x",
        "_wyd_control_audit_abs_y",
        "_wyd_control_audit_width",
        "_wyd_control_audit_height",
        "_wyd_control_grid_rows",
        "_wyd_control_grid_columns",
        "_wyd_control_grid_item_count",
        "_wyd_control_grid_item_width",
        "_wyd_control_grid_item_height",
        "_wyd_control_grid_item_cell_x",
        "_wyd_control_grid_item_sindex",
        "_wyd_control_selected_short_skill",
        "_wyd_control_assigned_short_skill",
        "_wyd_control_audit_click_skill_cell",
        "_wyd_control_audit_populate_skill_belt",
        "_wyd_set_field_mode",
        "_wyd_get_field_mode",
