...
constexpr DWORD D3DXSPRITE_DONOTSAVESTATE = 0x00000001u;
constexpr DWORD D3DXSPRITE_DONOTMODIFY_RENDERSTATE = 0x00000002u;
constexpr DWORD D3DXSPRITE_OBJECTSPACE = 0x00000004u;
constexpr DWORD D3DXSPRITE_BILLBOARD = 0x00000008u;
constexpr DWORD D3DXSPRITE_ALPHABLEND = 0x00000010u;
constexpr DWORD D3DXSPRITE_SORT_TEXTURE = 0x00000020u;
constexpr DWORD D3DXSPRITE_SORT_DEPTH_FRONTTOBACK = 0x00000040u;
...
D3DXQUATERNION* D3DXQuaternionSlerp(D3DXQUATERNION*, const D3DXQUATERNION*, float);
