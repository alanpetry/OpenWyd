	...
	m_vecEndPos{}
{
	...
	m_vertex2[0].position = TMVector3{ vecStart.x - m_fScaleH, vecStart.y, vecStart.z };
	m_vertex2[1].position = TMVector3{ vecEnd.x - m_fScaleH, vecEnd.y, vecEnd.z };
	m_vertex2[2].position = TMVector3{ vecEnd.x + m_fScaleH, vecEnd.y, vecEnd.z };
	m_vertex2[3].position = TMVector3{ vecStart.x + m_fScaleH, vecStart.y, vecStart.z };
