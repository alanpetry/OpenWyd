...
int TMEffectBillBoard3::Render()
{
	...
	const auto drawResult1 = g_pDevice->m_pd3dDevice->DrawPrimitiveUP(D3DPT_TRIANGLEFAN, 2u, m_vertex1, 24u);
	const auto drawResult2 = g_pDevice->m_pd3dDevice->DrawPrimitiveUP(D3DPT_TRIANGLEFAN, 2u, m_vertex2, 24u);
	...
	if (drawResult1 < 0 || drawResult2 < 0)
		return 0;
