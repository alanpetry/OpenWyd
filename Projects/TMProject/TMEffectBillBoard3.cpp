...
int TMEffectBillBoard3::Render()
{
	...
	HRESULT hrVertex1 = g_pDevice->m_pd3dDevice->DrawPrimitiveUP(D3DPT_TRIANGLEFAN, 2u, m_vertex1, 24u);
	HRESULT hrVertex2 = g_pDevice->m_pd3dDevice->DrawPrimitiveUP(D3DPT_TRIANGLEFAN, 2u, m_vertex2, 24u);
	...
	if (FAILED(hrVertex1) || FAILED(hrVertex2))
		return 0;
