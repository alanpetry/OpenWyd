...
int TMEffectBillBoard3::Render()
{
	...
	bDrawFailed |= g_pDevice->m_pd3dDevice->DrawPrimitiveUP(D3DPT_TRIANGLEFAN, 2u, m_vertex1, 24u) < 0;
	bDrawFailed |= g_pDevice->m_pd3dDevice->DrawPrimitiveUP(D3DPT_TRIANGLEFAN, 2u, m_vertex2, 24u) < 0;
